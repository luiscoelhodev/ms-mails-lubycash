...
export function getTemplate(
  ...
  switch (subject) {
    ...
    case SubjectEnum.accepted:
      return `<h1>Hey, ${user.name}!</h1><p>We're very happy to announce that you've been accepted as our new customer! We'd like to thank you for your interest in using our banking services and we hope to always serve you well.</p>`
